...
def render_actions(plan: dict[str, Any]) -> str:
    ...
    for row in rows[:30]:
        ...
        body.append(
            ...
            f"<td>{esc(row.get('correlation', {}).get('note'))}</td>"
            "</tr>"
        )
    if not body:
...
<body>
  ...
  <main>
    ...
    <h2>Action Plan</h2>
    <table>
      <thead><tr><th>Action</th><th>Ticker</th><th>Strategy</th><th>Score</th><th>Size</th><th>Limit</th><th>Floor</th><th>Exec</th><th>Profile</th><th>Correlation</th></tr></thead>
