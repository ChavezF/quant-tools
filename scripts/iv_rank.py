...
def main():
    ...
    print(f"          IVRank 25-50 = below median (cautious short premium, smaller size).")
    print(f"          IVRank 50-75 = above median (sweet spot for short premium).")
    print(f"          IVRank > 75 = rich premium (aggressive short premium / earnings plays).")
