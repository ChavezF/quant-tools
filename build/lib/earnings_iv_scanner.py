...
def main():
    ...
    for symbol in args.watchlist:
        ...
        # rv_21d_pct is annualized; expected 1-sigma move over D days = annual% * sqrt(D/252)
    ...
    print("        SELL PREMIUM = IV > RV by >5% (sell straddle / strangle, expect crush).")
    print("        BUY STRADDLE = IV < RV by >3% (cheap vol, expect drift).")
