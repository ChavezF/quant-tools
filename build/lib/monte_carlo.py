...
def main():
    ...
    for sim in out.get("simulations", []):
        ...
        print("    P&L distribution (% of notional):")
    ...
    if "historical_replay" in out and out["historical_replay"]:
        print("  HISTORICAL REPLAY (if you'd held a 16Δ strangle through these shocks):")
    ...
    print("  Reading guide:")
    print("    The '95% worst' / '5% worst' / '1% worst' lines are the most important.")
    print("    If 1% worst is worse than -3%, the strategy has tail risk that 8-event backtests hide.")
    print("    Compare PARAMETRIC vs BOOTSTRAP — if bootstrap shows worse tails, the empirical")
    print("    distribution has fat tails the log-normal assumption misses.")
